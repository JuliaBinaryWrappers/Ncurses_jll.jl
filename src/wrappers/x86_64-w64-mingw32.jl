...
const libpanel_splitpath = ["bin", "libpanel.dll"]
...
const libpanel = "libpanel.dll"


# Relative path to `libform`
const libform_splitpath = ["bin", "libform.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libform = "libform.dll"


# Relative path to `libmenu`
const libmenu_splitpath = ["bin", "libmenu.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libmenu = "libmenu.dll"


# Relative path to `libncurses`
const libncurses_splitpath = ["bin", "libncurses.dll"]
